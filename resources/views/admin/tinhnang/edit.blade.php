...
<div class="card" >
    <div class="card-body">
        <form action="{{route('tinhnang.update',$data->id)}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf @method('PUT')
            <div class="form-group">
                ...
                <a href="{{route('tinhnang.index')}}" class="btn btn-sm btn-danger mb-3">
                    <i class="fas fa-sign-out-alt"> Quay về bảng tính năng</i>     
                </a>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <input type="text" value="{{$data->tentinhnang}}" class="form-control" name="tentinhnang" id="tentinhnang" autocomplete="off" required >
                    </div>
