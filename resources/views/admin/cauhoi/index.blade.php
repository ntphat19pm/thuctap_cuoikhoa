...
{{-- <form action="" class="form-inline">
  ...
  <button type="submit" class="btn btn-primary">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3">
      ...
      <a href="{{route('cauhoi.create')}}" class="btn btn-outline-secondary mt-2"><i class="fas fa-plus-circle"></i> Thêm câu hỏi</a> 
        ...
        <table id="example1" class="table table-bordered table-striped">
          <thead>
            <tr>
              ...
              <th class="text-center" scope="col">Trả lời</th>
            ...
            <tr>
              ...
              <td>
                ...
                @elseif($item->trangthai==1)
                  <a href="{{ route('cauhoi.unactive',$item->id)}}"><i style="color:rgb(8, 253, 0)" class="far fa-check-circle fa-lg"></i></a>
                @endif
              </td>            
              <td class="text-right">
                <a href="{{route('cauhoi.edit',$item->id)}}" class="btn btn-sm btn-success">
                  <i class="fas fa-edit"></i>              
                </a> 
                <a  href="{{route('cauhoi.destroy',$item->id)}}" class="btn btn-sm btn-danger btndelete">
