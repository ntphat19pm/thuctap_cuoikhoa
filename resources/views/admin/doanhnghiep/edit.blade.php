...
<div class="card" >
    <div class="card-body">
        <form action="{{route('doanhnghiep.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="form-group invalid">
                    <label for="ten_kh" class="form-label">Tên bài</label>
                    <input type="text" value="{{$data->ten_kh}}" class="form-control" name="ten_kh" id="ten_kh" required >
                  </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
