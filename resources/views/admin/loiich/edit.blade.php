...
<div class="card" >
    <div class="card-body">
        <form action="{{route('loiich.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <input type="text" value="{{$data->tenloiich}}" class="form-control" name="tenloiich" id="tenloiich" required >
                    </div>
